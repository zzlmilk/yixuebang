...
drug.prototype.submitInfo = function(type) {
    ...
    if (i == 3) {
        ...
        var url = base.getDomainUrl() + '/pageredirst.php?action=drug&functionname=add_drug_ajax';

        base.ajax(url, 'post', formData, function success(data) {

            var url = 'pageredirst.php?action=drug&functionname=drug_list';

...
clinical.prototype.submitInfo = function(type) {
    ...
    if (i == 3) {
        ...
        var url = base.getDomainUrl() + '/pageredirst.php?action=clinical&functionname=add_clinical_ajax';

        base.ajax(url, 'post', formData, function success(data) {

            var url = 'pageredirst.php?action=clinical&functionname=clinical_list';

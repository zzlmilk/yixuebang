...
<head>
    ...
    <script src="{$MAINPUBLIC}/javascript/operation.js"></script>
    <script>
    $(function() {
...
<body>
    <div style='margin-top: 30px;margin-left: 20px; overflow: auto;min-height: 700px;'>
        ...
        <div class="form-group">
            ...
            <div>
                ...
                <button class="btn btn-default" type="submit" onclick='base.getType(8,1)' id='type_1_div_name'>{$data.type.name}</button>
                {else}
        ...
        <div class="form-group">
            <label for="college_type">手术知识二级分类(如心胸外科)</label>
             <div>
                ...
                <button class="btn btn-default" type="submit" onclick='base.getType(8,2)' id='type_2_div_name'>{$data.type_2.name}</button>
                {else}
         ...
         <div class="form-group">
            <label for="college_type">手术知识三级分类(如硬脊膜外脓肿手术)</label>
             <div>
                ...
                <button class="btn btn-default" type="submit" onclick='base.getType(8,3)' id='type_3_div_name'>{$data.type_3.name}</button>
                {else}
 ...
 -->
        ...
        <button type="submit" class="btn btn-default" onclick='operation.submitInfo({$operation_type})'>保存</button>

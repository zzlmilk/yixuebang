    ...
    <div class="modal-dialog">
        <div class="modal-content" style='width:375px;'>
            <div class="modal-header">
                ...
                <h4 class="modal-title">{$name}小分类</h4>
            </div>
            <div class="modal-body" id='preview_body'>
                <div style='max-height: 300px;padding-left: 25px;overflow-y: auto;' class='form-inline'>
                    ...
                    <label class="radio-inline" style='width:100px;height:50px;padding:0;margin:0;'>
                        <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="{$datas.id}"><span id='branch_type_{$datas.id}' style='display:inline-block;width:100px;overflow: hidden;'>{$datas.branch_type_name}</span>
                    </label>
                    {/foreach}
                </div>
                <div class='form-inline'>
                    ...
                    <button type="submit" class="btn btn-default" onclick='base.saveBranchType({$type})'>保存</button>
                </div>
